  ...
  'returned target': [
    {
      ...
      value: 'Reviewed Target',
      color: 'purple-6',
      description: 'Review the resubmitted target.',
    },
  ],
  'received accomplishment': [
    {
      ...
      color: 'green-7',
      description: 'Prevalidate the received accomplishment submission.',
    },
    {
  ...
  'returned accomplishment': [
    {
      ...
      value: 'Prevalidated Accomplishment',
      color: 'green-7',
      description: 'Prevalidate the resubmitted accomplishment report.',
    },
  ],
}
...
const statusColor = (status) => {
  const colorMap = {
    ...
    'prevalidated accomplishment': 'green-7',
  }
...
const getButtonLabel = () => {
  ...
  if (currentStatus === 'received target' || currentStatus === 'returned target') {
    return 'Update Target Status'
  }

  if (currentStatus === 'received accomplishment' || currentStatus === 'returned accomplishment') {
...
const getButtonTooltip = () => {
  ...
  if (currentStatus === 'received target' || currentStatus === 'returned target') {
    return 'Update the target status for this employee'
  }

  if (currentStatus === 'received accomplishment' || currentStatus === 'returned accomplishment') {
    return 'Update the accomplishment status for this employee'
  }
...
const handleUpdateStatus = async () => {
  ...
  try {
    ...
    // Remove the success notification here since parent will show it
    closeUpdateModal()
    emit('close')
  } catch (error) {
