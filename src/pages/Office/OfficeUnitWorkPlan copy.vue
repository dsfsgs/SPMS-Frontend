            ...
            {{
              currentEmployee?.performanceStandards?.[currentStandardIndex]
                ...
                : currentEmployee?.performanceStandards?.[currentStandardIndex]
                  ...
                  ? 'Enter Target Output (Cannot exceed 100%)'
                  : 'Enter Target Output'
            }}
          </div>
  ...
  setup() {
    ...
    const computeQuantities = (type = null, index = null) => {
      ...
      if (currentType === 'B') {
        ...
        // === TYPE C: Cannot exceed 100% (Static Display with "100%" in Success Indicator) ===
        if (!quantityValue.value || isNaN(quantityValue.value)) {
          $q.notify({
        ...
        // Store the target value (for record keeping)
        ...
        // Generate success indicator with "100%" (not the target value)
        generateSuccessIndicator(idx)
        ...
        // If head employee, apply to all staff
        if (dominoIsHead(currentEmployee.value.id)) dominoApplyToAllStaff()
      } else {
